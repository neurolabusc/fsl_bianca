...
pth = '/home/chris/natalie/FLAIRS'; %output path
tmp = '/home/chris/natalie/tmp';
outpth = '/home/chris/natalie/out';
...
for s = 1 : numel(T1s)
    ...
    FL = dirNii(fullfile(p, ['FLAIR_',subj,'*']));
    ...
    FL = nii_copies(FL, tmp, '');
    [eT1, rlesion, eT2, eFLAIRs ] = enat(T1,les,T2, FL);
    fnms = [{eT1}, {eT2}, eFLAIRs];
    extract(fnms);
